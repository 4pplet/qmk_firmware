...
[0] = LAYOUT_all(
  ...
  KC_LSFT, 	KC_NUBS, KC_Z,   KC_X,    KC_C,    KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  KC_NO,                KC_NO,      KC_UP,      KC_NO,
  KC_LCTL, 	KC_LGUI, KC_LALT,KC_NO,   KC_NO,   KC_SPC, KC_NO, 			         KC_RALT, KC_RGUI, KC_APP,  KC_RCTL,                        KC_LEFT,    KC_DOWN,    KC_RGHT)
};
