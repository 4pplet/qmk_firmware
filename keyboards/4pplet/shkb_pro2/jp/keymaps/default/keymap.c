...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |Fn ||Ctl|Alt|Cmd|Mhn|   Space   |Hen|Kan|Alt|Fn ||Lft|Dwn|Rgh|
     * `-----------------------------------------------------------'
     */
    [0] = LAYOUT(
        ...
        MO(1),   KC_LCTL, KC_LALT, KC_LGUI, KC_INT5, KC_SPC,  KC_INT4, KC_INT2, KC_RALT, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
